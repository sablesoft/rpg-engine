...
3. Ensure the scenario title and any newly introduced entity names are distinct from other established entity names inside that same world context unless the same entity is intentionally being revised.
4. Create or update a world-owned scenario structure following `products/rpg-engine/assets/workspace_templates/scenario_structure.md` and using:
...
5. Ensure the scenario depends on world canon instead of redefining it.
6. Keep enough structure for later adventure setup and play.
